 ...
 * and ns for time.
 * Attention: This class corresponds to the fixed the the vertex time generation of HLLHCEvtVtxGenerator defined in SLHC releases
 * Called in SLHC HLLHCEvtVtxGeneratorFix.h
 * $Id: HLLHCEvtVtxGenerator.h,v 1.0 2015/03/15 10:34:38 Exp $
 */
