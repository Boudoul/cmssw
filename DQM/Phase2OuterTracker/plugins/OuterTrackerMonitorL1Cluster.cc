...
//
/**\class Phase2OuterTracker OuterTrackerMonitorL1Cluster.cc DQM/Phase2OuterTracker/plugins/OuterTrackerMonitorL1Cluster.cc
...
#include "DQM/Phase2OuterTracker/interface/OuterTrackerMonitorL1Cluster.h"
...
//
OuterTrackerMonitorL1Cluster::OuterTrackerMonitorL1Cluster(const edm::ParameterSet& iConfig)
...
OuterTrackerMonitorL1Cluster::~OuterTrackerMonitorL1Cluster()
{
...
void OuterTrackerMonitorL1Cluster::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
void
OuterTrackerMonitorL1Cluster::beginRun(const edm::Run& run, const edm::EventSetup& es)
{
...
void 
OuterTrackerMonitorL1Cluster::endJob(void) 
{
	
}

DEFINE_FWK_MODULE(OuterTrackerMonitorL1Cluster);
